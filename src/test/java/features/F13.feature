Feature: Gestionar direcciones de envío
  ...
  Scenario: Añadir una nueva dirección de envío
    ...
    And El usuario agrega una nueva dirección con:
      ...
      | Apellido       | David              |
      | Empresa        | MiEmpresa          |
      | Dirección 1    | Calle Falsa 123    |
      | Dirección 2    | Piso 3, Puerta A   |
      | Ciudad         | Madrid             |
      | Código Postal  | 28000              |
      | País           | Spain              |
      | Región/Estado  | Madrid             |
  ...
  Scenario: Editar una dirección existente
    ...
    And El usuario edita la dirección a:
      | Nombre         | Javier             |
      | Apellido       | David              |
      | Empresa        | MiNuevaEmpresa     |
      | Dirección 1    | Calle Verdadera 456|
      | Dirección 2    | Piso 4, Puerta B   |
      | Ciudad         | Barcelona          |
      | Código Postal  | 28001              |
      | País           | Spain              |
      | Región/Estado  | Barcelona          |
